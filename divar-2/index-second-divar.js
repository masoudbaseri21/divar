...
//    second-divar
    $('.service-jQ-divar-2').mouseover(function (){
        $('.menu-left-jQ-divar2').hide();
        $('.menu-right-jQ-divar2').show();
        $('.menu-left-jQ-divar2-2').hide();
        $('.menu-right-jQ-divar2-2').show();
    })
    $('.service-jQ-divar-2').mouseout(function (){
        $('.menu-left-jQ-divar2').show();
        $('.menu-right-jQ-divar2').hide();
        $('.menu-left-jQ-divar2-2').show();
        $('.menu-right-jQ-divar2-2').hide();
    })
//    skill
    $('.skill-jQ-divar-2').mouseover(function (){
        $('.menu-left-jQ-divar2-2').hide();
        $('.menu-right-jQ-divar2-2').show();
    })
    $('.skill-jQ-divar-2').mouseout(function (){
        $('.menu-left-jQ-divar2-2').show();
        $('.menu-right-jQ-divar2-2').hide();
    })
})